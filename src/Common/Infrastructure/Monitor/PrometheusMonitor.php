 ...
 * which is used to register and collect metrics data. It utilizes Redis (Alternative PHP Cache)
...
final class PrometheusMonitor
{
    ...
    /**
     * Initializes the PrometheusMonitor with a CollectorRegistry using Redis storage.
     */
